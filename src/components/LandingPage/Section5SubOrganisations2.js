...
class Section5SubOrganisations2 extends React.Component {
  render() {
    ...
    return (
      <div className="section5__block2">
        ...
        <article className="section5__article">
          <div>
            <h3>Organizacja "Dolor sit amet 1"</h3>
        ...
        <article className="section5__article">
          <div>
            <h3>Organizacja "Dolor sit amet 2""</h3>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor.
            </p>
        ...
        <article className="section5__article">
          <div>
            <h3>Organizacja "Dolor sit amet 3"</h3>
            <p>
...
export default Section5SubOrganisations2;
